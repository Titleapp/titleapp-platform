...
- [ ] **Gate on step 1's first real external send:** AI-disclosure convention for outbound persona comms decided (risk register #6) — see Open Decisions.
- [ ] **Gate on step 1's first real external send:** correction protocol defined for when a persona's external comms are wrong (risk register #8) — see Open Decisions.
