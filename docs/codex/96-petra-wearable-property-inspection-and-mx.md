...
4. **EMTAK/ruleset gap, same shape as CODEX 87 §6 item 8:** the insurer-documentation Tier 1 ruleset (what specifically do insurers require, and does it vary meaningfully by carrier/region) hasn't been researched yet — needs its own short pass before Tier 1 content can be encoded for real.
