...
**Status:** ⚪ spec, mostly not built · **safetyContact activation gate built, wired, and edge-case-hardened** (§0C, §0D) · **real forcing function landed 2026-08-27** (§1A) · **red-teamed 2026-08-27, four rounds** (§0, §0B, §0C, §0D)
