...
const MARKETPLACE_SLUG_MAP = {
  ...
  "TITLE-ABSTRACT-001": "title-abstract-001",
  "LAW-LANDUSE-001": "law-landuse-001",
  "ZONING-001": "zoning-001",
  "FEASIBILITY-001": "feasibility-001",
  ...
  // CODEX 60 consolidated workers (7-worker architecture)
  "AV-A01": "av-aircraft",
  "AV-M01": "av-mx",
  "AV-D01": "av-dispatch-v2",
  "AV-T01": "av-training",
  "AV-O01": "av-operations",
  "AV-S01": "av-safety-v2",
  "AV-C01": "av-copilot",
  "AV-C02": "av-copilot-pc12",
  "AV-C03": "av-copilot-b200",
  "AV-C04": "av-copilot-b350",
  "AV-C05": "av-copilot-c90",
  "AV-C06": "av-copilot-208b",
  // Solar Energy
...
const RULESET_MAP = {
  ...
  "av-aircraft": "av_a01_aircraft_v0",
  "av-mx": "av_m01_mx_v0",
  "av-dispatch-v2": "av_d01_dispatch_v0",
  "av-training": "av_t01_training_v0",
  "av-operations": "av_o01_operations_v0",
  "av-safety-v2": "av_s01_safety_v0",
  "av-copilot": "av_c01_copilot_v0",
  "av-copilot-pc12": "av_c02_copilot_pc12_v0",
  "av-copilot-b200": "av_c03_copilot_b200_v0",
  "av-copilot-b350": "av_c04_copilot_b350_v0",
  "av-copilot-c90": "av_c05_copilot_c90_v0",
  "av-copilot-208b": "av_c06_copilot_208b_v0",
  // Web3
...
const DISPLAY_NAME_MAP = {
  ...
  "LAW-LANDUSE-001": "Land Use Attorney",
  "ZONING-001": "Zoning + Entitlement",
  "FEASIBILITY-001": "Market & Feasibility Study",
  "W-010": "Government Relations",
  "W-030": "Appraisal & Valuation",
  "W-034": "Rent Roll & Revenue",
  "W-037": "HOA & Association",
  ...
  "AV-S01": "SAFETY",
  "AV-C01": "CoPilot",
  "AV-C02": "CoPilot — PC-12 NG",
  "AV-C03": "CoPilot — King Air B200",
  "AV-C04": "CoPilot — King Air B350",
  "AV-C05": "CoPilot — King Air C90",
  "AV-C06": "CoPilot — Caravan 208B",
  // Health & EMS Education
...
const HEADLINE_MAP = {
  ...
  // CODEX 60 consolidated workers
  "av-aircraft": "The aircraft record — event source for MX, Dispatch, Operations, Safety, and CoPilot",
  "av-mx": "All maintenance in one worker — MEL, ADs, work orders, components, parts",
  "av-dispatch-v2": "Every flight released with full context — airworthiness, crew legality, weather, FRAT",
  "av-training": "Complete crew certificate ladder, recurrent calendar, and crew legality feed",
  "av-operations": "Crew scheduling, duty time, reserve management, and the crew legality engine",
  "av-safety-v2": "SMS, FOQA, drug/alcohol, incident reporting, ERP — independent of operational pressure",
  "av-copilot": "Your personal pilot record — logbook, currency, medical, schedule, flight planning",
  "av-copilot-pc12": "Type-intelligent CoPilot for the Pilatus PC-12/47E — systems, QRH, performance, W&B",
  "av-copilot-b200": "Type-intelligent CoPilot for the King Air B200 — systems, QRH, performance, W&B",
  "av-copilot-b350": "Type-intelligent CoPilot for the King Air B350 — systems, QRH, performance, W&B",
  "av-copilot-c90": "Type-intelligent CoPilot for the King Air C90GTx — systems, QRH, performance, W&B",
  "av-copilot-208b": "Type-intelligent CoPilot for the Cessna Caravan 208B — systems, QRH, performance, W&B",
  // Health & EMS Education
...
async function notifyAlex(db, worker) {
  ...
  await db.collection("alex").doc("knowledge").collection("workers").doc(worker.worker_id).set({
    ...
    is_tech_fee_vertical: ["re_sales", "property_management"].includes(worker.vertical),
