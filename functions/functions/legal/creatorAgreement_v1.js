...
This Creator Agreement ("Agreement") is between you ("Creator") and SOCIII, Inc. ("SOCIII," "we," "us"). By publishing a Digital Worker on the SOCIII platform, you agree to the following terms.

1. DEFINITIONS

"Digital Worker" means an AI-powered agent built on the SOCIII platform that performs specific tasks for subscribers using rules, compliance logic, and AI models.

"Subscriber" means any person or entity that subscribes to or uses a Digital Worker you have published.

"Platform" means the SOCIII infrastructure, including the rules engine, compliance engine, AI models, vault, audit trail, and marketplace.
...
2.2 You will not publish Digital Workers that violate applicable laws, regulations, or the SOCIII Terms of Service.
...
3.1 SOCIII operates a 75/25 revenue split on subscription revenue. You receive 75% of each subscriber's monthly payment. SOCIII retains 25%.
...
3.6 SOCIII reserves the right to adjust revenue share percentages with 90 days written notice. Changes apply to new subscriptions only; existing subscriptions are grandfathered for 12 months.

4. INTELLECTUAL PROPERTY

4.1 You retain ownership of the original rules, configurations, and prompts you create for your Digital Worker.

4.2 SOCIII retains ownership of the platform, the rules engine, the AI models, the vault, and all underlying infrastructure.

4.3 You grant SOCIII a non-exclusive, worldwide license to host, distribute, and display your Digital Worker on the platform for the purpose of serving subscribers.

4.4 SOCIII does not claim ownership of your Digital Worker's output. Output ownership follows the subscriber's terms of service. [LEGAL_REVIEW_REQUIRED]

5. LIABILITY AND DISCLAIMERS

5.1 SOCIII provides the platform and compliance engine. SOCIII does not guarantee the correctness of creator-configured rules, prompts, or worker behavior.
...
5.3 SOCIII is not liable for losses, damages, or claims arising from your Digital Worker's outputs or subscriber's reliance on those outputs.

5.4 You agree to indemnify SOCIII against claims arising from your Digital Worker's configuration, rules, or outputs. [LEGAL_REVIEW_REQUIRED — indemnification scope]
...
7.1 If you do not log in for 90 consecutive days and your account is in arrears, SOCIII may transfer your Digital Worker to SOCIII ownership to protect subscribers.
...
7.4 During the abandoned period, SOCIII receives the full creator revenue share.
...
8.2 SOCIII may remove your Digital Worker if it violates this Agreement, the Terms of Service, or applicable law.
...
9.1 SOCIII will not build Digital Workers that directly compete with creator-built workers in the same vertical and specific use case.

9.2 SOCIII may build template or starter workers to seed verticals before creators fill them.

9.3 SOCIII retains the right to build platform-level workers (Alex, vault management, admin tools).
...
11.1 SOCIII may modify this Agreement with 30 days written notice. Continued use of the platform after the notice period constitutes acceptance.
