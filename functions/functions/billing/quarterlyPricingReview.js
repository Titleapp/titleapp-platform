 ...
 * Emails sean@sociii.ai and kent@sociii.ai.
 */
...
async function sendReviewEmail(subject, htmlBody) {
  ...
  await fetch("https://api.sendgrid.com/v3/mail/send", {
    ...
    body: JSON.stringify({
      ...
      from: { email: "reports@sociii.ai", name: "SOCIII Reports" },
      subject,
...
async function runQuarterlyPricingReview() {
  ...
  if (totalEvents === 0) {
    await sendReviewEmail(
      `SOCIII Quarterly Pricing Review — ${quarterLabel}`,
...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 700px; margin: 0 auto; padding: 24px;">
  <h2 style="color: #7c3aed;">SOCIII Quarterly Pricing Review — ${quarterLabel}</h2>
  ...
  <p style="margin-top: 24px; color: #94a3b8; font-size: 13px;">Auto-generated by SOCIII Quarterly Pricing Review. Rates from config/pricing.js.</p>
</div>`;
