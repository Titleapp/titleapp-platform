  ...
  return new Promise((resolve, reject) => {
    ...
    const doc = new PDFDocument({
      ...
      info: {
        ...
        Author: data.author || brand.name || "SOCIII",
        Creator: "SOCIII Document Engine",
        Producer: "SOCIII.ai",
      },
    });
...
function addFooter(doc, brand, pageNum, totalPages) {
  ...
  doc.fontSize(FONTS.footer.size)
    ...
    .text(
      brand.aiDisclosure ||
        "Generated by SOCIII Digital Worker. AI-assisted analysis — human review recommended.",
...
function renderReport(doc, data, brand, logoBuffer) {
  ...
  doc.fontSize(FONTS.caption.size)
    ...
    .fillColor(COLORS.textLight)
    .text(
      brand.footerText || "Confidential — Generated by SOCIII.ai",
      { align: "center" }
    );
...
function renderDealRiskSummary(doc, data, brand, logoBuffer) {
  ...
  doc.moveDown(2);
  doc.fontSize(FONTS.caption.size).font(FONTS.caption.font).fillColor(COLORS.textLight)
    .text("Risk assessment generated by a SOCIII Digital Worker. For informational purposes only.", { align: "center" });
}
...
function renderBidPackage(doc, data, brand, logoBuffer) {
  ...
  doc.moveDown(4);
  doc.fontSize(FONTS.caption.size).font(FONTS.caption.font).fillColor(COLORS.textLight)
    .text(brand.footerText || "Confidential — Generated by SOCIII.ai", { align: "center" });
