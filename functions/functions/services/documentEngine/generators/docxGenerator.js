...
// DOCX generation via docx package — covers agreement-standard, letter-formal
...
async function generateDocx({ template, data, brand, logoBuffer }) {
  ...
  const doc = new Document({
    ...
    description: `Generated by SOCIII.ai for ${brand.name || "SOCIII"}`,
    sections,
  });
  ...
  return new Paragraph({
    ...
    children: [
      new TextRun({
        text:
          brand.aiDisclosure ||
          "This document was generated by a SOCIII Digital Worker with the assistance of artificial intelligence. All data should be independently verified. Human review recommended.",
        size: 16,
        color: "6B7280",
        italics: true,
        font: "Arial",
    ...
    default: new Footer({
      children: [
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: brand.footerText || "Generated by SOCIII.ai",
              size: 16,
              color: "6B7280",
              font: "Arial",
            }),
...
function buildLetter(data, brand) {
  ...
  children.push(
    new Paragraph({
      ...
      children: [
        new TextRun({
          text: data.from || brand.name || "SOCIII",
          bold: true,
          size: 24,
          color: primaryColorHex(brand),
          font: "Arial",
