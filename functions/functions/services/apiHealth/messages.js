...
/**
 * messages.js — Alex Plain-Language Error Messages (41.3-T2 Layer 2)
 *
 * When callWithHealthCheck() returns success: false, the calling
 * service passes serviceName to getErrorMessage(). Alex uses this
 * instead of showing a blank field or technical error.
 *
 * Rule: Alex NEVER says "API error", "503", "connection refused",
 * or any technical language. Always plain language. Always a path forward.
 */
 ...
 *
 * @param {string} serviceName — e.g. "notamify", "vincario"
