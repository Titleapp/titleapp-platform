...
const PRESS_ITEMS = [
  {
    ...
    bodyHtml: `
      ...
      <p>"A passport is only as good as the system that produced it," said Kent Redwine, co-founder of SOCIII, who has a long history in the electric vehicle industry. "If a manufacturer can just type in whatever composition and origin data it wants, with nobody able to verify it later, you haven't solved the counterfeit problem. You've just given it a form to fill out."</p>
