...
function findHandoffWorker(vertical, subscribedWorkers, triggerDescription) {
  ...
  const VERTICAL_WORKER_MAP = {
    ...
    "real-estate": {
      ...
      "title question": { slug: "re-title-search-001", name: "Title Search" },
      "title search": { slug: "re-title-search-001", name: "Title Search" },
      "chain of title": { slug: "re-title-search-001", name: "Title Search" },
