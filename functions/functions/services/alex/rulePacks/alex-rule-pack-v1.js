...
const layer1 = {
  ...
  facts: {
    ...
    workerCount: "1,000+",
    pricing: { tier1: 29, tier2: 49, tier3: 79, creator: 49, bundle: 99 },
    pricingCurrency: "USD",
    pricingPeriod: "per month",
    noTierForWorkers: [99],
    bundleProduct: { name: "Business in a Box", price: 99 },
  },
  hardStops: [
    ...
    { id: "no_99_tier", pattern: /\$99\s*\/?\s*mo/i, message: "Never quote $99 for an individual worker — $99/mo is only valid for the Business in a Box bundle", contextAllow: /business\s+in\s+a\s+box|BoB|bundle|package/i },
