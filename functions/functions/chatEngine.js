...
// ──────────────────────────────────────────────────────────────
// chatEngine.js — SOCIII Conversation State Machine
//
...
const PITCHES = {
  auto: "SOCIII creates a Digital Title Certificate for your vehicle -- it tracks ownership, service history, mileage, and documents all in one verified record. Takes about 2 minutes to set up.\n\nWould you like to get started? It's free.",
  property: "SOCIII keeps a complete verified record of your property -- purchase documents, renovations, inspections, insurance. Everything organized and in one place.\n\nWould you like to get started? It's free.",
  education: "SOCIII creates a verified, portable record of your academic history -- transcripts, diplomas, certifications. Stored permanently and shareable with employers or institutions.\n\nWould you like to get started? It's free.",
  credential: "SOCIII creates a verified record of your professional credentials -- licenses, certifications, memberships, training. Tracked, verified, and always accessible.\n\nWould you like to get started? It's free.",
  pet: "SOCIII creates a verified health record for your pet -- vaccinations, vet visits, medications, all in one place. Shareable with any vet or boarding facility.\n\nWould you like to get started? It's free.",
  business: "SOCIII's Revenue Engine finds hidden opportunities in your customer database, automates follow-up, and helps your team close more deals. Built for dealerships and asset-heavy businesses.\n\nWant to see how it works?",
  compliance: "SOCIII monitors regulatory changes, tracks document retention, and keeps your records audit-ready. Automated compliance so nothing falls through the cracks.\n\nWant to learn more?",
};
...
function getDemoResponse(message) {
  ...
  if (msg.includes('car') || msg.includes('vehicle') || msg.includes('vin') ||
    ...
    return "SOCIII creates a verified digital record of your vehicle -- title, service history, mileage, everything in one place. It helps protect your car's value and makes selling easier. Want to get started?";
  }
  ...
  if (msg.includes('student') || msg.includes('transcript') || msg.includes('school') ||
    ...
    return "SOCIII creates a verified, portable record of your academic history -- transcripts, diplomas, certifications. Stored permanently and shareable with employers or institutions. Want to get started?";
  }
  if (msg.includes('credential') || msg.includes('certification') || msg.includes('license') ||
      msg.includes('professional') || msg.includes('cert')) {
    return "SOCIII creates a verified record of your professional credentials -- licenses, certifications, memberships, training. Tracked, verified, and always accessible. Want to get started?";
  }
  ...
  if (msg.includes('what') || msg.includes('who') || msg.includes('titleapp') || msg.includes('about')) {
    return "SOCIII is a platform of Digital Workers -- AI agents trained on the rules of specific industries. Over 1,000 workers across 14 industries handle compliance, document management, and specialized workflows. You can hire pre-built workers or build your own. What industry are you in?";
  }
  ...
  if (msg.includes('inventory') || msg.includes('sales follow') || msg.includes('pipeline') ||
    ...
    return "SOCIII handles your inventory, automates follow-up, and helps your team close more deals. Built for dealerships and asset-heavy businesses. Want to see how it works?";
  }
  if (msg.includes('compliance') || msg.includes('audit') || msg.includes('regulation') ||
      msg.includes('retention') || msg.includes('monitoring')) {
    return "SOCIII monitors regulatory changes, tracks document retention, and keeps your records audit-ready. Automated compliance so nothing falls through the cracks. Want to learn more?";
  }
  if (msg.includes('business') || msg.includes('company') || msg.includes('enterprise')) {
    return "SOCIII gives you a team of Digital Workers that handle records, compliance, follow-up, and deals -- all in one place. Over 1,000 workers across 14 industries. Starting at $29/month. What industry are you in?";
  }
  return "I'm Alex. SOCIII has over 1,000 Digital Workers across 14 industries -- real estate, construction, mortgage, title and escrow, legal, aviation, government, and more. What industry are you in? I'll show you what fits.";
}
...
async function processMessage(input, services = {}) {
  ...
  if (action === 'magic_link_clicked') {
    ...
    return response(state, `Account created. Welcome to SOCIII, ${state.name || 'friend'}.`, {
      cards: [{
        type: 'terms',
        data: {
  ...
  switch (state.step) {
    ...
    case 'choose_audience': {
      ...
      return response(state, "Are you looking to use SOCIII for personal use or for your business?", {
        cards: [{
          type: 'audienceSelect',
          data: {
            options: [
    ...
    case 're_tenant_name': {
      ...
      return response(state, "What's their email? We'll send them an invite to set up their own SOCIII account.");
    }
...
function handleTenantDTC(state) {
  ...
  return response(state, null, {
    ...
    followUpMessage: `Lease created for ${p.tenantName || 'tenant'}. An invite will be sent to ${p.tenantEmail || 'their email'} to set up their own SOCIII account.`,
    generateMilestone: true,
    aiContext: {
