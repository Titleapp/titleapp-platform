...
const CONNECTORS = {
  ...
  google_maps: {
    ...
    verticals: ["real_estate_development", "solar_vpp", "government", "aviation", "health_ems"],
  ...
  sendgrid: {
    ...
    verticals: ["real_estate_development", "solar_vpp", "aviation", "web3", "health_ems", "government", "marketing", "platform"],
    costPerSession: 0.00,
  ...
  quickbooks: {
    ...
    verticals: ["real_estate_development", "solar_vpp", "aviation", "platform"],
    costPerSession: 0.00,
  ...
  stripe: {
    ...
    verticals: ["real_estate_development", "solar_vpp", "aviation", "web3", "platform"],
    costPerSession: 0.00,
    costLabel: "Included with platform",
    tierRequired: "paid",
    requiresRaas: false,
  ...
  meta_posting: {
    ...
    verticals: ["real_estate_development", "solar_vpp", "aviation", "web3", "health_ems", "marketing"],
    costPerSession: 0.00,
    costLabel: "Free — subscriber authorizes access",
    tierRequired: "paid",
    requiresRaas: false,
  ...
  unified: {
    ...
    verticals: ["marketing", "real_estate_development", "solar_vpp", "aviation", "web3", "health_ems", "platform"],
    costPerSession: 0.00,
  ...
  google_business_posting: {
    ...
    verticals: ["real_estate_development", "solar_vpp", "health_ems", "marketing"],
    costPerSession: 0.00,
    costLabel: "Free — subscriber authorizes access",
    tierRequired: "paid",
    requiresRaas: false,
