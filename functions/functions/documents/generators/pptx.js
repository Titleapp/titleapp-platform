...
async function generatePptx(templateDef, content, branding) {
  ...
  const companyName = branding.companyName || "SOCIII";
  ...
  discSlide.addText(branding.footerText || "Generated by SOCIII Digital Worker. AI-assisted analysis — human review recommended.", {
