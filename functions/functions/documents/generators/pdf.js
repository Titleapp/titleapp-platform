  ...
  return new Promise((resolve, reject) => {
    ...
    const doc = new PDFDocument({
      ...
      info: {
        ...
        Author: branding.companyName || "SOCIII",
    ...
    function addFooters() {
      ...
      for (let i = 0; i < range.count; i++) {
        doc.switchToPage(i);
        // Stay within content area (page 792pt tall, bottom margin at 792-margins.bottom)
        const footerY = 792 - margins.bottom - 8;
        doc.fillColor(mutedColor).fontSize(7).font("Helvetica");
        doc.text(
          branding.footerText || "Generated by SOCIII Digital Worker. AI-assisted analysis — human review recommended.",
    ...
    if (templateId === "report-standard") {
      ...
      doc.x = margins.left; // reset after metrics grid (last column write shifts X cursor)
      hr();
      body(content.body || "");
