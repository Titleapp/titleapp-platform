...
async function generateDocx(templateDef, content, branding) {
  ...
  // AI disclosure
  children.push(hr());
  children.push(p(branding.footerText || "Generated by SOCIII Digital Worker. AI-assisted analysis — human review recommended.", { size: 16, color: mutedColor }));
  ...
  const footerParagraph = new Paragraph({
    ...
    children: [
      new TextRun({ text: `${branding.companyName || "SOCIII"} | Page `, size: 14, color: mutedColor, font: fontFamily }),
