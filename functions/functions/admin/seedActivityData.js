    ...
    if (commsCheck.empty) {
      ...
      const sampleMessages = [
        {
          ...
          body: "Hi Sean, I came across TitleApp and I'm impressed by the RAAS model. We're building compliance tooling for fintech companies and I think there's a strong integration play here. Would love to set up a 30-minute call this week to explore. Best, Jordan",
          intent: "partnership",
          sentiment: "positive",
      ...
      const sampleDrafts = [
        ...
        },
        {
          ...
          body: "Hi Maria, happy to chat for the Q1 roundup. I'm available next Tuesday or Wednesday, mornings work best. Our core angle: RAAS (Rules-as-a-Service) makes compliance portable and AI-auditable. Let me know what works.",
          status: "pending_review",
