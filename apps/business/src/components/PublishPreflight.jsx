...
const AGREEMENT_TEXTS = {
  creatorAgreement: {
    title: "TitleApp Creator Agreement",
    version: "CA-2026-01",
    body: `TitleApp Creator Agreement — Version CA-2026-01

Effective Date: Upon acceptance

This Creator Agreement ("Agreement") governs your use of TitleApp's platform to create, publish, and distribute Digital Workers.

1. REVENUE SHARE
You earn 75% of net subscription revenue generated by your Digital Worker. TitleApp retains 25%. Inference credit overage revenue is shared at 20% to creators. Payouts are processed monthly via Stripe Connect.

2. CONTENT OWNERSHIP
You retain full ownership of the rules, prompts, and domain expertise you contribute to your Digital Worker. TitleApp retains a non-exclusive license to host, distribute, and execute your Digital Worker on the platform.

3. PLATFORM USAGE
Your Digital Worker operates within TitleApp's rules engine. All outputs are validated against Tier 0 (platform safety) and applicable Tier 1 (regulatory) rules before delivery to subscribers. You may not bypass or disable the rules engine.
...
5. SUBSCRIBER DATA
You will not directly access subscriber data. All subscriber interactions are processed through TitleApp's platform. Aggregate, anonymized usage metrics are provided to you via weekly Alex check-ins.
...
7. LIABILITY
TitleApp provides the platform infrastructure but does not guarantee the accuracy of creator-configured rules or outputs. You agree to indemnify TitleApp against claims arising from your Digital Worker's outputs.

8. MODIFICATIONS
TitleApp may update this Agreement with 30 days notice. Continued use of the platform after notice constitutes acceptance.
...
By checking the box below, you acknowledge that you have read, understood, and agree to this Creator Agreement.`,
  ...
  liabilityDisclaimer: {
    ...
    version: "LD-2026-01",
    body: `TitleApp Liability Disclaimer — Version LD-2026-01

Effective Date: Upon acceptance

By publishing a Digital Worker on TitleApp, I acknowledge and accept the following:
...
2. TitleApp provides the platform infrastructure, rules engine, and distribution network. TitleApp does not independently verify the accuracy of creator-configured rules or guarantee specific outcomes.
...
6. I understand that TitleApp may deactivate my Digital Worker if it receives credible reports of harmful, inaccurate, or non-compliant outputs.
            ...
            {!done && !isLast && gate.id === "creatorAgreement" && (
              <div style={S.gateDesc}>
                {viewedAgreement.creatorAgreement
                  ? "I agree to the TitleApp Creator Agreement (CA-2026-01). Covers revenue share (75/25), content ownership, and termination."
