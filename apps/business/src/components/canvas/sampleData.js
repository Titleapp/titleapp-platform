...
const SPINE_FIXTURES = {
  ...
  "platform-hr": {
    "people": {
      ...
      fields: [
        { label: "Total",           value: "9" },
        { label: "Clinical staff",  value: "5" },
        { label: "Digital workers", value: "4" },
        { label: "Open roles",      value: "1" },
      ],
      people: [
        { name: "Dr. Maya Chen, DVM",  type: "human",          role: "Owner · Lead Veterinarian", status: "active" },
        { name: "Dr. Jordan Park, DVM", type: "human",         role: "Associate Veterinarian",     status: "active" },
        { name: "Sam Rivera, CVT",     type: "human",          role: "Certified Vet Technician",   status: "active" },
        { name: "Alex Torres",         type: "human",          role: "Veterinary Assistant",       status: "active" },
        { name: "Casey Kim",           type: "human",          role: "Practice Manager",           status: "active" },
        ...
        { name: "Drug Dosing Worker",  type: "digital_worker", role: "VET-003",                    status: "active" },
      ],
    },
    "onboarding": {
      ...
      fields: [
        { label: "Open",        value: "1 new hire" },
        { label: "Awaiting I-9", value: "1" },
        { label: "Equipment",   value: "Pending" },
        { label: "Start date",  value: "2026-07-01" },
      ],
      items: [
        "Riley Morgan — Veterinary Receptionist · I-9 collected, scrubs + DMS login pending · starts 2026-07-01",
        "Alex Torres — OSHA Bloodborne Pathogen refresher overdue since 2026-05-20 · reminder drafted",
      ],
    },
    "schedule": {
      title: "Coverage",
      subtitle: "Meadow Creek · today's shift roll-up",
      fields: [
        { label: "On shift now",    value: "4 clinical" },
        { label: "Digital workers", value: "4 (24×7)" },
        { label: "On PTO",          value: "1" },
        { label: "Coverage",        value: "Healthy" },
      ],
      sections: [
        { heading: "On shift now",  body: "Dr. Maya Chen · 08:00–17:00\nSam Rivera, CVT · 08:00–16:00\nAlex Torres · 09:00–17:00\nCasey Kim · 08:00–16:00" },
        { heading: "Digital workers (24×7×365)", body: "Accounting · Contacts · Marketing · Drug Dosing" },
        { heading: "Out today",     body: "Dr. Jordan Park · PTO through Fri" },
      ],
    },
    "compliance": {
      title: "HR compliance",
      subtitle: "Meadow Creek · platform_hr_compliance_v1 + OSHA veterinary",
      summary: "Federal + CA baseline active. One OSHA training overdue — hard-stop until cleared.",
      fields: [
      ...
      sections: [
        { heading: "Open obligations", body: "Alex Torres — OSHA Bloodborne Pathogen training overdue since 2026-05-20 (hard_stop)\nMid-year performance reviews — not yet scheduled (soft_flag)" },
        { heading: "Federal coverage", body: "I-9 · W-4 · FLSA · ACA · COBRA · FMLA · OSHA — current" },
        { heading: "State + sector", body: "CA: harassment training (2yr cycle) · final paycheck timing · DEA controlled-substance handling logs" },
      ],
    },
    "documents": {
      title: "HR documents",
      subtitle: "Meadow Creek · agreements + signed packets",
      fields: [
        { label: "Total",          value: "11" },
        { label: "Signed",         value: "9" },
        { label: "Pending sig",    value: "1" },
        { label: "Expiring 30d",   value: "1" },
      ],
      sections: [
        { heading: "Recent",       body: "Employee Handbook 2026 — acknowledged by all staff\nOSHA Bloodborne Pathogen Exposure Plan — current\nSam Rivera — CVT credential on file · exp 2026-07-21" },
      ],
    },
    "notices": {
      title: "HR notices",
      subtitle: "Meadow Creek · outbound communications",
      fields: [
        { label: "Sent 30d",       value: "6" },
        { label: "Queued",         value: "1" },
        { label: "Failed",         value: "0" },
      ],
      sections: [
        { heading: "Recent sends",  body: "OSHA refresher reminder — Alex Torres · 2026-06-22\nNew-hire welcome — Riley Morgan · 2026-06-20\nQuarterly compliance digest — all staff · 2026-06-01" },
      ],
    },
    "my-onboarding": {
