...
const WORKER_NAV_MAP = {
  ...
  "aviation": [
    { id: "av-aircraft",     label: "AIRCRAFT" },
    { id: "av-mx",           label: "MX" },
    { id: "av-dispatch",     label: "DISPATCH" },
    { id: "av-training",     label: "TRAINING" },
    { id: "av-operations",   label: "OPERATIONS" },
    { id: "av-safety",       label: "SAFETY" },
    { id: "av-copilot",      label: "CoPilot" },
    { id: "av-copilot-pc12", label: "CoPilot — PC-12" },
    { id: "av-copilot-b200", label: "CoPilot — B200" },
    { id: "av-copilot-b350", label: "CoPilot — B350" },
    { id: "av-copilot-c90",  label: "CoPilot — C90" },
    { id: "av-copilot-208b", label: "CoPilot — Caravan" },
  ],
  "web3": [
