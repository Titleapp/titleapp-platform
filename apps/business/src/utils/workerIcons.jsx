...
// Shared worker icon map — Lucide/Feather style, consistent viewBox and stroke.
...
const ICONS = {
  ...
  "environmental-review": (
    <>
      ...
      <path d="M17 8c4 0 8.5-1 9-5-4.5 0-6.5 1-9 5z" />
      <path d="M2 12c2-4 6-8 12-8" />
    </>
  ),
  "mortgage-broker": (
    <>
...
export default function WorkerIcon({ slug, size = 24, color = "currentColor", className = "" }) {
  const paths = ICONS[slug];
  if (!paths) {
    // Fallback: generic bot/worker icon
    return (
      <svg
        width={size}
        height={size}
