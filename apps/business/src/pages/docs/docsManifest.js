...
export const DOCS_MANIFEST = [
  {
    ...
    pages: [
      ...
      { slug: "the-workspace", title: "Everything you get", description: "The whole package: Personas, Drive, Vault (+ tabs), the Workers you get and what they replace, Billing — the customer-service & value guide." },
