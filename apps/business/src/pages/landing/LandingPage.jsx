    ...
    <div style={S.page}>
      ...
      <nav style={S.nav}>
        <div style={S.navInner}>
          <a href="https://sociii.ai" style={{ ...S.logo, display: "flex", alignItems: "center", gap: 10 }}>
            <img src={sociiiMarkUrl} alt="" width={28} height={28} style={{ display: "block", borderRadius: 6 }} />
            <span>SOCIII</span>
          </a>
