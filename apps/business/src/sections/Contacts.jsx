    ...
    <div>
      ...
      <div className="pageHeader" style={{ alignItems: "center" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, rowGap: 6, flexWrap: "wrap" }}>
          ...
          <span title="Active workspace — contacts are isolated per workspace" style={{ padding: "4px 10px", borderRadius: 999, fontSize: 12, fontWeight: 600, background: "#ede9fe", color: "#6d28d9", display: "inline-flex", alignItems: "center", gap: 6, whiteSpace: "nowrap" }}>
