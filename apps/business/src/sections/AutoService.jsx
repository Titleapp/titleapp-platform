...
const SERVICE_SCHEDULE = {
  Monday: [
    { time: "7:00 AM", customer: "Lawrence Foster", vehicle: "2024 Camry SE", vin: "...N25012", service: "30K Maintenance", advisor: "Mike Torres", bay: 3, cost: 389, status: "confirmed", upsell: null, salesOpp: null },
    ...
    { time: "8:00 AM", customer: "Charles Cox", vehicle: "2023 Tacoma TRD Sport", vin: "...T23088", service: "60K Major Service", advisor: "Sarah Kim", bay: 1, cost: 449, status: "confirmed", upsell: "Factory warranty expiring -- pitch Extra Care Gold ($2,995)", salesOpp: { type: "upgrade", note: "2025 Tacoma TRD Pro available" } },
    { time: "9:00 AM", customer: "James Mitchell", vehicle: "2022 Highlander Limited", vin: "...H22033", service: "Brake Inspection + Pads", advisor: "Sarah Kim", bay: 7, cost: 285, status: "confirmed", upsell: null, salesOpp: null },
    ...
    { time: "11:00 AM", customer: "Angela Williams", vehicle: "2021 Prius Prime", vin: "...P21019", service: "Hybrid Battery Check + Multi-Point", advisor: "David Park", bay: 2, cost: 95, status: "pending", upsell: "Vehicle 4+ years old -- trade-up candidate", salesOpp: { type: "trade-up", note: "4+ yrs old, high equity -- 2025 Prius Prime" } },
    { time: "1:00 PM", customer: "Thomas Garcia", vehicle: "2024 Tundra SR5", vin: "...U24007", service: "Recall Campaign -- Seat Belt Retractor", advisor: "David Park", bay: 8, cost: 0, status: "confirmed", upsell: null, salesOpp: null },
    { time: "2:30 PM", customer: "Diana Brooks", vehicle: "2022 Venza Limited", vin: "...V22015", service: "Transmission Flush + Coolant", advisor: "Sarah Kim", bay: 6, cost: 329, status: "pending", upsell: "Approaching 50K -- present extended warranty options", salesOpp: { type: "upgrade", note: "Crown comparable -- $2K equity advantage" } },
  ],
  Tuesday: [
    ...
    { time: "10:00 AM", customer: "Lisa Johnson", vehicle: "2022 Corolla LE", vin: "...C22089", service: "AC Compressor Diagnosis", advisor: "Mike Torres", bay: 9, cost: 149, status: "pending", upsell: null, salesOpp: { type: "trade-up", note: "Repair cost high -- present Corolla Cross upgrade" } },
  ...
  Wednesday: [
    { time: "7:00 AM", customer: "Richard Brown", vehicle: "2023 Tundra Limited", vin: "...U23015", service: "45K Service", advisor: "Sarah Kim", bay: 1, cost: 359, status: "confirmed", upsell: "Bed liner application ($595)", salesOpp: null },
    ...
    { time: "10:30 AM", customer: "Carol Thompson", vehicle: "2022 Highlander XLE", vin: "...H22078", service: "Brake Pads + Rotors", advisor: "Sarah Kim", bay: 3, cost: 445, status: "pending", upsell: "Approaching 60K -- warranty pitch", salesOpp: { type: "upgrade", note: "Grand Highlander -- $4K positive equity" } },
    { time: "1:00 PM", customer: "George Martinez", vehicle: "2021 Tacoma SR", vin: "...T21055", service: "Recall -- Leaf Spring", advisor: "Mike Torres", bay: 10, cost: 0, status: "confirmed", upsell: "Vehicle 5 years old -- trade-up opportunity", salesOpp: { type: "trade-up", note: "5 yrs old, strong residual -- 2025 Tacoma SR5" } },
  ],
  Thursday: [
    ...
    { time: "9:00 AM", customer: "Maria Gonzalez", vehicle: "2024 Corolla LE", vin: "...C24033", service: "Tire Rotation + Inspection", advisor: "Mike Torres", bay: 3, cost: 49, status: "pending", upsell: "Lease expiring in 60 days -- upgrade discussion", salesOpp: { type: "lease-end", note: "Lease ends Apr 2026 -- present Corolla Hybrid" } },
    ...
    { time: "1:30 PM", customer: "Barbara Kim", vehicle: "2022 Prius LE", vin: "...P22041", service: "Hybrid System Diagnostic", advisor: "Sarah Kim", bay: 8, cost: 149, status: "confirmed", upsell: null, salesOpp: { type: "trade-up", note: "3+ yrs, high mileage -- 2025 Prius upgrade" } },
  ...
  Friday: [
    ...
    { time: "9:30 AM", customer: "Mark Brown", vehicle: "2025 Corolla Cross LE", vin: "...CC25009", service: "5K First Service", advisor: "Mike Torres", bay: 5, cost: 0, status: "confirmed", upsell: "Cross-sell RAV4 upgrade opportunity", salesOpp: { type: "upgrade", note: "RAV4 Hybrid -- natural upgrade path" } },
    ...
    { time: "1:00 PM", customer: "Karen Taylor", vehicle: "2022 4Runner SR5", vin: "...4R22019", service: "75K Major Service", advisor: "David Park", bay: 2, cost: 549, status: "pending", upsell: "Extended warranty -- factory coverage ending", salesOpp: { type: "trade-up", note: "High mileage -- 2025 4Runner or Grand Highlander" } },
  ],
};
                    ...
                    {appt.salesOpp ? (
                      <div>
                        <span style={{
                          ...
                          padding: "2px 8px",
                          borderRadius: "9999px",
                          background: appt.salesOpp.type === "trade-up" ? "#f3e8ff" : appt.salesOpp.type === "lease-end" ? "#dbeafe" : "#fef3c7",
                          color: appt.salesOpp.type === "trade-up" ? "#7c3aed" : appt.salesOpp.type === "lease-end" ? "#2563eb" : "#d97706",
                          marginBottom: "2px",
                        }}>
                          {appt.salesOpp.type}
                        </span>
                        <div style={{ fontSize: "11px", color: "#64748b", marginTop: "2px", maxWidth: "180px" }}>{appt.salesOpp.note}</div>
                      </div>
                    ) : (
