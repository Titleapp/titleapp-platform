...
export default function Reports() {
  ...
  function exportPDF() {
    ...
    const kpis = getKpiConfig();
    win.document.write(`<html><head><title>SOCIII Report</title><style>
    ...
    win.document.write(`<h1>SOCIII -- ${isVault ? "Vault" : "Business"} Report</h1><div class="sub">Generated ${new Date().toLocaleDateString()}</div>`);
