...
<div class="header">
<div class="branding"><div>${companyName ? `<strong>${companyName}</strong>` : ""}</div><div>Prepared by SOCIII</div></div>
...
<div class="disclaimer">This analysis is AI-generated and should be verified independently. It does not constitute financial advice. Generated by SOCIII on ${date}.</div>
