		...
		return __PRIVATE_unguardedEventListen(u, WebChannel.EventType.OPEN, (() => {
			...
			if (!l) {
				...
				if (s$1) {
					...
					"NOT_FOUND" === t$2 && i$2.includes("database") && i$2.includes("does not exist") && i$2.includes(this.databaseId.database) && __PRIVATE_logWarn(`Database '${this.databaseId.database}' not found. Please check your project configuration.`), void 0 === n$2 && (n$2 = C.INTERNAL, i$2 = "Unknown error status: " + t$2 + " with message " + s$1.message), l = !0, h.o_(new FirestoreError(n$2, i$2)), u.close();
