...
> CAUTION — REFERENCE MATERIAL ONLY. You are operating with platform reference templates (white-label GOM, SOP, MEL, NEF, and flight operations documents), NOT your own FAA-approved documents. These templates are generic examples that have NOT been reviewed or approved by the FAA for your specific operation. They may contain procedures, limitations, dispatch minimums, or operational guidance that differ from your approved documents. Do not use these templates as the basis for dispatch, flight operations, or maintenance decisions without verifying against your own FAA-approved documents. Upload your own GOM, SOP, MEL, NEF, OpSpecs, and AFM/POH for accurate operational outputs. Use AV-001 (Certificate Assistant) to begin document upload or AV-002 (GOM Authoring) to generate documents for FAA submission.
