...
**PC-12 NG Enhanced Training Library:** For the Pilatus PC-12/47E (NG variant), the worker includes FlightSafety International training materials (4,209 pages) covering: FSI safety briefs (runway excursion prevention, GNSS interference), the complete MMEL (Doc 02395 Rev 08, EASA Approved, all ATA chapters with rectification intervals and CAS messages), the full PIM (Report 02277, all sections 0-9 including emergency and abnormal procedures), the Honeywell Primus APEX Pilot's Guide (PFD, MFD, FMS, AFCS, navigation, weather radar, TAWS, TCAS), and knowledge check questions. Reference: `training/fsi-pc12ng-training.md`. Full PDF: `gs://title-app-alpha.firebasestorage.app/raas/aviation/GLOBAL/reference/fsi/FSI_PC12NG_Materials.pdf`.
