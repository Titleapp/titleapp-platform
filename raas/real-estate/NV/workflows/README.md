# Real Estate Workflows — Nevada (NV)

These workflows are the “front door” for the Real Estate vertical in Nevada.  
Pattern:

- **Collect required inputs**
- **Run jurisdiction-aware checks**
- **Produce packet / record anchor / next action**

---

## Machine-readable workflows (NV)

> The API reads this list to populate `/v1/raas:workflows?vertical=real-estate&jurisdiction=NV`
...
```json
{
  ...
  "workflows": [
    ...
    },
    {
      ...
      "name": "Preliminary Title Report (NV)",
    ...
    },
    {
      ...
      "name": "Full Blockchain Report (NV)",
    ...
    },
    {
      ...
      "name": "Purchase & Sale Transaction (NV)",
    ...
    },
    {
      ...
      "name": "Residential Lease — New (NV)",
      "description": "Create a residential lease workflow: tenant screening inputs, lease terms, required NV disclosures checklist, signing, and move-in checklist.",
    ...
    },
    {
      ...
      "name": "HOA Resale Package / Documents (NV)",
    ...
    },
    {
      ...
      "name": "Create Property Record Anchor (NV)",
